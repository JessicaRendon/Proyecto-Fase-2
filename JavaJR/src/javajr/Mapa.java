        ...
        while(a<Jugadores){
            if(vacios()>0){
                if(a<9){     
                    ...
                    if (mapa [i][j].isVacio()&&mapa [i][j].jugador==null){
             ...
             for (int j=0; j<b+2;j++){
                if(mapa[i][j].jugador!=null){
                    if(mapa[i][j].jugador.valor.compareTo(jug)==0){ 
                        switch(dir){
                            case "W":
                                if(mapa[i-1][j].getCasilla().compareTo("x")!=0&&mapa[i-1][j].jugador==null){
                                    mapa[i-1][j].jugador= new Jugador(mapa[i][j].jugador);
                            ...
                            break;
                            case "A":
                                if(mapa[i][j-1].getCasilla().compareTo("x")!=0&&mapa[i][j-1].jugador==null){
                                    mapa[i][j-1].jugador= new Jugador(mapa[i][j].jugador);
                                    mapa[i][j].jugador.valor=null;
                                    mapa[i][j]=new Vacio();
                                }else{                                   
                                    if(mapa[i][j-1].jugador!=null){
                                       System.out.println("No se puede mover sobre otro jugador");
                                   }else{
                                       System.out.println("No se puede salir del mapa");
                                   }
